...
const PortfolioItem = (props) => {
  ...
  return (
    <div className="w-full lg:w-1/2">
      <div className="m-4 shadow p-6 rounded-md bg-white group hover:shadow-md">
        <div className="relative mb-6 w-full h-56 bg-purple-200 rounded-md overflow-hidden">
          <img src="" alt="" />
          <div className="absolute opacity-0 transition duration-200 bg-purple-100 w-full flex items-center justify-center h-full left-0 top-0 group-hover:opacity-100 group-hover:visible">
